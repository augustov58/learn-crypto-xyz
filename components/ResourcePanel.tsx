...
export default function ResourcePanel({ topic, color, onClose }: ResourcePanelProps) {
  ...
  return (
    ...
    >
      ...
      <div
        ref={panelRef}
        className="relative z-10 max-h-screen overflow-y-auto"
          ...
          <div className="max-w-7xl mx-auto px-6 py-6">
            <div className="flex justify-between items-start">
              <div className="flex-1">
                <h1 id={`${topic.id}-title`} className="text-4xl font-bold text-gray-800 dark:text-gray-100">
                  {topic.name}
                </h1>
                <p
                  id={`${topic.id}-description`}
                  className="text-gray-600 dark:text-gray-400 mt-3 text-lg"
                >
                  {topic.description}
                </p>
                ...
                {/* Progress bar */}
                <div className="mt-3 w-full max-w-md bg-gray-200 dark:bg-gray-700 rounded-full h-2" aria-hidden="true">
                  <div
